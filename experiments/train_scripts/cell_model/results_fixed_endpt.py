...
def format_plots():
    ...
    plt.rcParams.update(figsizes.aistats2022_full(nrows=2, ncols=2))
...
if __name__ == "__main__":
    ...
    cell_500 = sde_cell_model.cell_model(T=T, N=500)
    ...
    diffusion_bridge_fw = np.load("/Users/libbybaker/Documents/Python/Heng_DiffusionBridge/cell/cell_traj_T_2.0_X0_tensor([0.1000, 0.1000])_XT_tensor([1.5000, 0.2000])_M_50_50.npy")
    ...
    diffusion_bridge_bw = np.load("/Users/libbybaker/Documents/Python/Heng_DiffusionBridge/cell/cell_traj_T_2.0_X0_tensor([0.1000, 0.1000])_XT_tensor([1.5000, 0.2000])_M_50_bw.npy")
    ...
    axs["proposed"] = plot_trajectories(conditioned_trajs[:100], cell_50.time_grid, 0, axs["proposed"], 'C0', **plot_kwargs)
    axs["proposed"] = plot_trajectories(conditioned_trajs[:100], cell_50.time_grid, 1, axs["proposed"], 'C1', **plot_kwargs)
