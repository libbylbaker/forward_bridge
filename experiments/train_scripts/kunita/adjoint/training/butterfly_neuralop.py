...
def main(key):
    ...
    num_landmarks = 32
    y = data_boundary_pts.butterfly1(num_landmarks)

    sigma = 0.04
    kappa = 1 / sigma

    sde_args = {"T": 1., "N": 100, "num_landmarks": num_landmarks, "y": y, "sigma": sigma, "kappa": kappa, "grid_size": 50, "grid_range": (-0.5, 1.5)}
