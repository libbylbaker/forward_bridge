...
def main(key, n=2, T=2.0):
    ...
    sde = {"x0": [1.0, 1.0], "N": 100, "dim": n, "T": T, "y": [2.0, 0.3]}
    dt = sde["T"] / sde["N"]

    y = sde["y"]
    x0 = sde["x0"]
    dim = sde["dim"]
    checkpoint_path = f"/Users/libbybaker/Documents/Python/doobs-score-project/doobs_score_matching/checkpoints/cell/fixed_x0_{x0}_y_{y}_guided"
